...
import 'package:secytask/navbar/MyItems/myItemPreview.dart';
import '../navbar/MyItems/uploadProduct.dart';
    ...
    return InkWell(
      onTap: () {
        Navigator.push(
            context,
            MaterialPageRoute(
                builder: (context) => myItemPreview(
                      itemName: widget.itemName,
                      itemPrice: widget.itemPrice,
                      itemDescription: widget.itemDescription,
                      images: widget.images,
                      refreshParent: widget.refresh,
                    )));
      },
      child: Padding(
